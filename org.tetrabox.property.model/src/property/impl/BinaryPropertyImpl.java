 ...
 * </p>
 * <ul>
 *   <li>{@link property.impl.BinaryPropertyImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link property.impl.BinaryPropertyImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BinaryPropertyImpl<L, R> extends PropertyImpl implements BinaryProperty<L, R> {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLeft(L newLeft, NotificationChain msgs) {
		L oldLeft = left;
		left = newLeft;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRight(R newRight, NotificationChain msgs) {
		R oldRight = right;
		right = newRight;
		if (eNotificationRequired()) {
